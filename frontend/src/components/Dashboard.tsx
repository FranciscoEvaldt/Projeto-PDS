...
export function Dashboard() {
  ...
  useEffect(() => {
    ...
    const testsOverdue = samples.filter((s) => {
      ...
      return (
        s.data_prevista_rompimento && s.data_prevista_rompimento < todayISO
      );
    });
    ...
    testsOverdue.sort(
      (a, b) => (a.numero_laboratorio || 0) - (b.numero_laboratorio || 0)
    );
    testsToday.sort(
      (a, b) => (a.numero_laboratorio || 0) - (b.numero_laboratorio || 0)
    );
        ...
        <Card>
          <CardHeader>
            ...
            <Tabs
              ...
              onValueChange={(value: string) => setSelectedPeriod(value as any)}
            >
          ...
          <CardContent>
            {(() => {
              ...
              const displayTests = showAllToday
                ? currentTests
                : currentTests.slice(0, MAX_SAMPLES_DISPLAY);
                    ...
                    {displayTests.map((sample) => {
                      ...
                      if (
                        ...
                        const testDate = new Date(
                          sample.data_prevista_rompimento + "T00:00:00"
                        );
                        ...
                        >
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-gray-600">
                              {work?.nome} - Planilha #{load?.numero_planilha} -{" "}
                              {sample.idade_dias} dias
                            </p>
                          </div>
                          <Badge
                            variant={
