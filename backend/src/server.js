...
async function startServer() {
  try {
    ...
    if (!connected) {
      ...
      console.error('');
      console.error('Crie um arquivo .env na pasta backend com o seguinte conteúdo:');
      console.error('');
    ...
    app.listen(PORT, () => {
      ...
      console.log('');
      console.log('💡 Dica: Configure o frontend em /services/api.ts para apontar para esta URL');
      console.log('═══════════════════════════════════════════════════════════');
      console.log('');
    });
